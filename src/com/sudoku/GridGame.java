...
public class GridGame {
    ...
    public GridGame () {
        ...
        observers = new ArrayList<SudokuQQ>(4);
        hasChanged = false;
    ...
    public static int getX(int cell) {
        return (cell & GridGame.MASK_X) >>> 28;
    }
    
    public static int getY(int cell) {
        return (cell & GridGame.MASK_Y) >>> 24;
    }
    ...
    public void setRealGridVal(int realGridVal) {
        int x = GridGame.getX(realGridVal);
        int y = GridGame.getY(realGridVal);
    ...
    //OBSERVERS MANEGMANT
    public void addObserver(SudokuQQ so) {
        observers.add(so);
    }
    ...
    public void setSerGrid(SGrid sg) {
        for(int i = 0; i < 9; i++) {
            for(int j = 0; j < 9; j++) {
